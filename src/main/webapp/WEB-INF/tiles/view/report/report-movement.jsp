...
<form:form method="POST" action="kiosk-search" modelAttribute="kiosk" class="form-horizontal"> 
	...
	<div class="row">
	    ...
	    <div class="form-group col-md-12">
	   	...
	   	<div class="form-group col-md-12">
	        ...
	        <div class="col-md-4">
	            <form:input type="text" path="dateFrom" class="form-control input-sm" />
	        </div>
	    </div>
	    ...
	    <div class="form-group col-md-12">
	        ...
	        <div class="col-md-4">
	            <form:input type="text" path="dateTo" class="form-control input-sm" />
	        </div>
	    </div>
